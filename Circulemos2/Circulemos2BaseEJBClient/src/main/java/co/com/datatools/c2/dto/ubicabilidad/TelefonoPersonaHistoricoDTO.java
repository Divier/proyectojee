 ...
 */
public class TelefonoPersonaHistoricoDTO implements EntidadDtoC2 {
    ...
    private TelefonoPersonaDTO telefonoPersona;

    // --- Constructor
    public TelefonoPersonaHistoricoDTO() {
    }

    public TelefonoPersonaHistoricoDTO(Long id) {
        this.id = id;
    ...
    public TelefonoPersonaDTO getTelefonoPersona() {
        return telefonoPersona;
    }

    public void setTelefonoPersona(TelefonoPersonaDTO telefonoPersona) {
