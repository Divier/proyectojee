...
/**
 * Dto para regla q consulta el listado de codigos alfa numericos de las infraccion pedagogicas de un organismo de transito en una fecha especifica
 * 
 * @author felipe.martinez
 */
public class ConsInfraccionesPedagOrgTranDTO implements Serializable {
    ...
    public ConsInfraccionesPedagOrgTranDTO() {
        super();
        codigoAlfaNumInfraccion = new ArrayList<>();
    }

    public ConsInfraccionesPedagOrgTranDTO(Integer codigoOrganismo, Date vigente) {
        this();
