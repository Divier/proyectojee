 ...
 * 
 */
public class DetalleComparendoEcuadorFL implements Serializable {

    private static final long serialVersionUID = 1L;

    public static final String NOMBRE_BEAN = "detalleComparendoPeruFL";
    ...
    public DetalleComparendoEcuadorFL() {
    }

    public DetalleComparendoEcuadorFL(ComparendoDTO comparendoDTO) {
    ...
    public final String getDireccionEmpresaTexto() {
        return direccionEmpresaTexto;
    }

    public final void setDireccionEmpresaTexto(String direccionEmpresaTexto) {
        this.direccionEmpresaTexto = direccionEmpresaTexto;
    }

    public final String getNombrePatio() {
        return nombrePatio;
    }

    public final void setNombrePatio(String nombrePatio) {
