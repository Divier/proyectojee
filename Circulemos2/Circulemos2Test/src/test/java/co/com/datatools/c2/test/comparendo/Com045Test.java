...
public class Com045Test extends BaseTest {

    private static final Logger logger = Logger.getLogger(Car003Test.class.getName());

    private static final String[] scripts = { "scripts/pruebas/comparendo/COM_045001.sql",
            "scripts/pruebas/comparendo/COM_045002.sql", };
    ...
    public void consultarComparendos() {
        logger.debug("Com045Test::consultarComparendos()");
        try {
