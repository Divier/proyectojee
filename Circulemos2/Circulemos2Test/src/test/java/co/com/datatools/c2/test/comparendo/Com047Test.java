...
public class Com047Test extends BaseTest {

    private static final Logger logger = Logger.getLogger(Car003Test.class.getName());

    private static final String[] scripts = { "scripts/pruebas/comparendo/COM_047001.sql",
            "scripts/pruebas/comparendo/COM_047002.sql", };
    ...
    public void consultarComparendos() {
        logger.debug("Com047Test::consultarComparendos()");
        try {
            ...
            consultaComparendoDTO.setIdTipoComparendo(EnumTipoComparendo.PAPELETA.getCodigo());
