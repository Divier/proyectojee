...
(
	...
	usuario_cambio VARCHAR(60) NOT NULL,
...
(
	...
	xml_historico TEXT NOT NULL,
	id_xsd_historico INTEGER NOT NULL,
	descripcion_cambio VARCHAR(250) NOT NULL,
	usuario_cambio VARCHAR(60) NOT NULL,
...
ALTER TABLE grupo_rol ADD CONSTRAINT FK_grupo_rol_01 	FOREIGN KEY (id_grupo) REFERENCES grupo (id_grupo);
