...
/**
 * Provides a {@link LoginContext} for use by unit tests. It is driven by users.properties and roles.properties files as described in <a
 * href="https://community.jboss.org/wiki/UsersRolesLoginModule">UsersRolesLoginModule</a>
 */
public class JBossLoginContextFactory {
    ...
    static class JBossJaasConfiguration extends Configuration {
        ...
        /**
         * The {@link org.jboss.security.ClientLoginModule} associates the user credentials with the {@link org.jboss.security.SecurityContext} where
         * the JBoss security runtime can find it.
         * 
         * @return
         */
        ...
        private AppConfigurationEntry createModuleConfigEntry() {
            Map<String, String> options = new HashMap<String, String>();
            return new AppConfigurationEntry("org.jboss.security.auth.spi.AbstractServerLoginModule",
                    AppConfigurationEntry.LoginModuleControlFlag.REQUIRED, options);
        }
    }
    ...
    public static LoginContext createLoginContext(final String username, final String password) throws LoginException {
        final String configurationName = "AutenticacionCirculemos";
        System.out.println("Entro a createLoginContext ::");
