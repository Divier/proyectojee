...
public class DocumentType implements java.io.Serializable {
    ...
    public static final java.lang.String _ANEXO = "ANEXO";
    public static final DocumentType MAIN = new DocumentType(_MAIN);
    public static final DocumentType ANEXO = new DocumentType(_ANEXO);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://coffice.net/cOfficeWebServices", "DocumentType"));
    }
    /**
