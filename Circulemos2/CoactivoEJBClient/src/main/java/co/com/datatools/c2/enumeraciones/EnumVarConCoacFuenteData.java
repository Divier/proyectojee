...
/**
 * Este Enum marca los separadores y palabras clave para identificar y procesar la fuente de los datos en las variables de condicion de las coactivo.
 * 
 * @author Dixon.Alvarez
 * 
 */
public enum EnumVarConCoacFuenteData {
    ...
    private EnumVarConCoacFuenteData(String value) {
        this.value = value;
    }
