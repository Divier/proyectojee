...
/**
 * @author Generated
 * @version 3.0 - Tue Oct 06 18:39:31 COT 2015
 */
public class EstadoComparendoDTO implements EntidadDtoC2 {
    ...
    // --- Constructor
    public EstadoComparendoDTO() {
    }

    public EstadoComparendoDTO(Integer id) {
        this.id = id;
