 ...
 */
@Entity
@Table(name = "inconsistencia_financiacion")
@NamedQuery(name = "InconsistenciaFinanciacion.findAll", query = "SELECT i FROM InconsistenciaFinanciacion i")
public class InconsistenciaFinanciacion implements EntidadC2 {
    ...
    @OneToMany(mappedBy = "inconsistenciaFinanciacion")
    private List<InconsistenciaDetalleCuotasFinanciacion> detalleCuotasFinanciacionList;
    ...
    public List<InconsistenciaDetalleCuotasFinanciacion> getDetalleCuotasFinanciacionList() {
        return detalleCuotasFinanciacionList;
    }

    public void setDetalleCuotasFinanciacionList(
            List<InconsistenciaDetalleCuotasFinanciacion> detalleCuotasFinanciacionList) {
        this.detalleCuotasFinanciacionList = detalleCuotasFinanciacionList;
    }

    public List<InconsistenciaDetalleFinanciacion> getDetalleFinanciacionList() {
        return detalleFinanciacionList;
    }

    public void setDetalleFinanciacionList(List<InconsistenciaDetalleFinanciacion> detalleFinanciacionList) {
        this.detalleFinanciacionList = detalleFinanciacionList;
    }

    // bi-directional many-to-one association to ItDetalleFinanciacion
    @OneToMany(mappedBy = "inconsistenciaFinanciacion")
    private List<InconsistenciaDetalleFinanciacion> detalleFinanciacionList;

    public InconsistenciaFinanciacion() {
    }
