...
import co.com.datatools.datatimer.c2.jobsexecution.AbrirProcesoCoactivoObligaciones;
...
public class JobAbrirProcesoCoactivoObligaciones extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobAbrirProcesoCoactivoObligaciones() {
        super();
    }
    ...
    protected void initDTOs() {
        ...
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob
                    .consultarConfiguracionJob(EnumJob.JOB_ABRIR_PROCESO_COACTIVO_OBLIGACIONES.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_ABRIR_PROCESO_COACTIVO_OBLIGACIONES,
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return AbrirProcesoCoactivoObligaciones.class;
    }
