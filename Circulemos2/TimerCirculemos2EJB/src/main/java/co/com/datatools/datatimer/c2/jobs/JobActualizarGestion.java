...
import co.com.datatools.datatimer.c2.jobsexecution.ActualizarGestion;
...
public class JobActualizarGestion extends DataTimerQuartz implements IRDataTimer {
    ...
    protected void initDTOs() {
        ...
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob.consultarConfiguracionJob(EnumJob.JOB_ACTUALIZAR_GESTION.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_ACTUALIZAR_GESTION, organismoTransitoDTO.getCodigoOrganismo(),
                            true);
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return ActualizarGestion.class;
    }
