...
import co.com.datatools.datatimer.c2.jobsexecution.ActualizarObligacionFinanciadaSac;
...
public class JobActualizarObligacionFinanciadaSac extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobActualizarObligacionFinanciadaSac() {
        super();
    }
    ...
    protected void initDTOs() {
        ...
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob
                    .consultarConfiguracionJob(EnumJob.JOB_ACTUALIZAR_OBLIGACION_FINANCIADA_SAC.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_ACTUALIZAR_OBLIGACION_FINANCIADA,
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return ActualizarObligacionFinanciadaSac.class;
    }
