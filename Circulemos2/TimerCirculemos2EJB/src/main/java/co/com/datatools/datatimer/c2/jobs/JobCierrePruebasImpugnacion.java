...
import co.com.datatools.datatimer.c2.jobsexecution.CierrePruebasImpugnacion;
...
public class JobCierrePruebasImpugnacion extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobCierrePruebasImpugnacion() {
        super();
    }
    ...
    protected void initDTOs() {
        ...
        this.logger.setLog(LevelLog.Info, "Iniciando metodo JobCierrePruebasImpugnacion::initDTOs()");
        LoginContext loginContext = null;
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob
                    .consultarConfiguracionJob(EnumJob.JOB_CIERRE_PRUEBAS_IMPUGNACION.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_CIERRE_PRUEBAS_IMPUGNACION,
            ...
            this.logger.setLog(LevelLog.Info, "Finalizando metodo JobCierrePruebasImpugnacion::initDTOs()");
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return CierrePruebasImpugnacion.class;
    }

    @Override
    protected void saveTrigger(TriggerDTO newTriggerDTO) throws SaveDataTimerException {
        this.logger.setLog(LevelLog.Info, "Iniciando metodo JobCierrePruebasImpugnacion::saveTrigger(TriggerDTO)");
        this.logger.setLog(LevelLog.Info, "Finalizando metodo JobCierrePruebasImpugnacion::saveTrigger(TriggerDTO)");
    }

    @Override
    protected void saveJob(JobDTO newJobDTO) throws SaveDataTimerException {
        this.logger.setLog(LevelLog.Info, "Iniciando metodo JobCierrePruebasImpugnacion::saveJob(JobDTO)");
        this.logger.setLog(LevelLog.Info, "Finalizando metodo JobCierrePruebasImpugnacion::saveJob(JobDTO)");
    }
