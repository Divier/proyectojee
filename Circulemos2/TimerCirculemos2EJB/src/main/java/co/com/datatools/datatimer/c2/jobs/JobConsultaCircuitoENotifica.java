...
import co.com.datatools.datatimer.c2.jobsexecution.ConsultaCircuitoENotifica;
...
public class JobConsultaCircuitoENotifica extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobConsultaCircuitoENotifica() {
        super();
    }
    ...
    protected void initDTOs() {
        ...
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob
                    .consultarConfiguracionJob(EnumJob.JOB_CONSULTA_CIRCUITO_E_NOTIFICA.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_CONSULTA_CIRCUITO_E_NOTIFICA,
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return ConsultaCircuitoENotifica.class;
    }
