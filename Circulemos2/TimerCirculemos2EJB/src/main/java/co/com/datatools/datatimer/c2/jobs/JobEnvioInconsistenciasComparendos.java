...
import co.com.datatools.datatimer.c2.jobsexecution.EnvioInconsistenciasComparendos;
...
public class JobEnvioInconsistenciasComparendos extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobEnvioInconsistenciasComparendos() {
        super();
    }
    ...
    protected void initDTOs() {
        ...
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob
                    .consultarConfiguracionJob(EnumJob.JOB_INCONSISTENCIAS_COMPARENDOS.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_ENVIO_INCONSISTENCIAS_COMPARENDOS,
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        // TODO Auto-generated method stub
        return EnvioInconsistenciasComparendos.class;
    }
