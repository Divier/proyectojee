...
import co.com.datatools.datatimer.c2.jobsexecution.EnvioInconsistenciasConciliacionRecaudo;
...
public class JobEnvioInconsistenciasConciliacionRecaudo extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobEnvioInconsistenciasConciliacionRecaudo() {
        super();
    }
    ...
    protected void initDTOs() {
        ...
        List<JobDTO> lJobDTO = iConfiguracionJob
                .consultarConfiguracionJob(EnumJob.JOB_INCONSISTENCIAS_CONCILIACION_RECAUDO.getId());
        ...
        if (lJobDTO != null && !lJobDTO.isEmpty()) {
            ...
            if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                ...
                ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                        EnumParametro.PERIODICIDAD_REPORTE_CONCILIACION_RECAUDO,
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        // TODO Auto-generated method stub
        return EnvioInconsistenciasConciliacionRecaudo.class;
    }
