...
import co.com.datatools.datatimer.c2.jobsexecution.EnvioRechazosRecaudo;
...
public class JobEnvioRechazosRecaudo extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobEnvioRechazosRecaudo() {
        super();
    }
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_GENERACION_RECEPCION_DATOS_RECAUDO,
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return EnvioRechazosRecaudo.class;
    }
