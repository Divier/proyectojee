...
import co.com.datatools.datatimer.c2.jobsexecution.RecibirGestionSac;
...
public class JobRecibirGestionSac extends DataTimerQuartz implements IRDataTimer {
    ...
    protected void initDTOs() {
        ...
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob.consultarConfiguracionJob(EnumJob.JOB_RECIBIR_GESTION_COBRO
                    .getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_RECIBIR_GESTION_COBRO,
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return RecibirGestionSac.class;
    }
