...
import co.com.datatools.datatimer.c2.jobsexecution.RegistrarObligacionSac;
...
public class JobRegistroObligacionSac extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobRegistroObligacionSac() {
        super();
    }
    ...
    protected void initDTOs() {
        ...
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob
                    .consultarConfiguracionJob(EnumJob.JOB_REGISTRAR_OBLIGACION_SAC.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.REGISTRAR_OBLIGACION_SAC, organismoTransitoDTO.getCodigoOrganismo(), true);
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return RegistrarObligacionSac.class;
    }
