...
import co.com.datatools.datatimer.c2.jobsexecution.ReplicarFinanciaciones;
...
public class JobReplicarFinanciaciones extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobReplicarFinanciaciones() {
        super();
    }
    ...
    protected void initDTOs() {
        ...
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob
                    .consultarConfiguracionJob(EnumJob.JOB_REPLICAR_FINANCIACIONES.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_REPLICAR_FINANCIACIONES,
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return ReplicarFinanciaciones.class;
    }
