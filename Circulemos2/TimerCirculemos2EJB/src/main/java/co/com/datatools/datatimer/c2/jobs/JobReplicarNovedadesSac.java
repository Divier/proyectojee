...
import co.com.datatools.datatimer.c2.jobsexecution.ReplicarNovedadesSac;
...
public class JobReplicarNovedadesSac extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobReplicarNovedadesSac() {
        super();
    }
    ...
    protected void initDTOs() {
        ...
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob
                    .consultarConfiguracionJob(EnumJob.JOB_REPLICAR_NOVEDADES_SAC.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_REPLICAR_NOVEDADES_SAC,
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return ReplicarNovedadesSac.class;
    }
