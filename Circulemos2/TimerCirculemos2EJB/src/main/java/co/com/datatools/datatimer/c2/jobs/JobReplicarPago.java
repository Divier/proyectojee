...
import co.com.datatools.datatimer.c2.jobsexecution.ReplicarPago;
...
public class JobReplicarPago extends DataTimerQuartz implements IRDataTimer {
    ...
    protected void initDTOs() {
        ...
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob.consultarConfiguracionJob(EnumJob.JOB_REPLICA_PAGO.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_SOLICITUD_DATOS_RECAUDO_TERCEROS,
