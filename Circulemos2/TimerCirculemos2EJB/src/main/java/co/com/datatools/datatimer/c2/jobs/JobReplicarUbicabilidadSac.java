...
import co.com.datatools.datatimer.c2.jobsexecution.ReplicarUbicabilidadSac;
...
public class JobReplicarUbicabilidadSac extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobReplicarUbicabilidadSac() {
        super();
    }
    ...
    protected void initDTOs() {
        ...
        this.logger.setLog(LevelLog.Info, "Iniciando metodo initDTOs() - JobReplicarUbicabilidadSac");
        LoginContext loginContext = null;
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob
                    .consultarConfiguracionJob(EnumJob.JOB_REPLICAR_UBICABILIDAD_SAC.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_REPLICAR_UBICABILIDAD_SAC,
            ...
            this.logger.setLog(LevelLog.Info, "Finalizando metodo initDTOs() - JobReplicarUbicabilidadSac");
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return ReplicarUbicabilidadSac.class;
    }
