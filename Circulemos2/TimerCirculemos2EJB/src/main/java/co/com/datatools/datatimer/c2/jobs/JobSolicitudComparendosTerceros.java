...
import co.com.datatools.datatimer.c2.jobsexecution.SolicitudComparendosTerceros;
...
public class JobSolicitudComparendosTerceros extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobSolicitudComparendosTerceros() {
        super();
    }
    ...
    protected void initDTOs() {
        ...
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob
                    .consultarConfiguracionJob(EnumJob.JOB_SOLICITUD_COMPARENDOS_TERCEROS.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_SOLICITUD_DATOS_COMPARENDOS_TERCEROS,
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return SolicitudComparendosTerceros.class;
    }
