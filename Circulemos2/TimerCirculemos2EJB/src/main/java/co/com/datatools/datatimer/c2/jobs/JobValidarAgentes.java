...
import co.com.datatools.datatimer.c2.jobsexecution.ValidarAgente;
...
public class JobValidarAgentes extends DataTimerQuartz implements IRDataTimer {
    ...
    protected void initDTOs() {
        ...
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob.consultarConfiguracionJob(EnumJob.JOB_VALIDAR_AGENTE.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_ABRIR_PROCESO_VALIDAR_AGENTE,
