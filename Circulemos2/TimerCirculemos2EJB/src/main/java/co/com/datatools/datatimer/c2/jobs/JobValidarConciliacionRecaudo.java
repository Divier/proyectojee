...
import co.com.datatools.datatimer.c2.jobsexecution.ValidarConciliacionRecaudo;
...
public class JobValidarConciliacionRecaudo extends DataTimerQuartz implements IRDataTimer {
    ...
    public JobValidarConciliacionRecaudo() {
        super();
    }
    ...
    protected void initDTOs() {
        ...
        this.logger.setLog(LevelLog.Info, "Iniciando metodo JobValidarConciliacionRecaudo.initDTOs()");
        LoginContext loginContext = null;
        try {
            List<JobDTO> lJobDTO = iConfiguracionJob
                    .consultarConfiguracionJob(EnumJob.JOB_VALIDAR_CONCILIACION_RECAUDO.getId());
            ...
            if (lJobDTO != null && !lJobDTO.isEmpty()) {
                ...
                if (lTriggerDTO != null && !lTriggerDTO.isEmpty()) {
                    ...
                    ValorParametroDTO valorParametroDTO = iRParametro.consultarParametro(
                            EnumParametro.PERIODICIDAD_VALIDAR_CONCILIACION, organismoTransitoDTO.getCodigoOrganismo(),
                            true);
                    triggerDTO.setExpressionCronTrigger(valorParametroDTO.getValorParam());
                }
                jobDTO.addTrigger(triggerDTO);
            }
            this.logger.setLog(LevelLog.Info, "Finalizando metodo JobValidarConciliacionRecaudo.initDTOs()");
    ...
    protected Class<? extends JobQuartz> getExecubleClass() {
        return ValidarConciliacionRecaudo.class;
    }
