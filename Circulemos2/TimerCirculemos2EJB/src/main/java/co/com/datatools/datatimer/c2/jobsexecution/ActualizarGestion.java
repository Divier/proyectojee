...
public class ActualizarGestion extends JobQuartz {

    private final static Logger logger2 = Logger.getLogger(ActualizarGestion.class.getName());
    ...
    public ActualizarGestion() {
        super();
    }

    @Override
    public void execute(JobExecutionContext context) throws JobExecutionException {
        logger2.debug("ActualizarGestion.execute()");
        ...
        try {
            ...
            // Llamado al metodo de actualizar cobros
            iRFachadaSac.actualizarGestionCobroTimer(organismoTransitoDTO.getCodigoOrganismo());
