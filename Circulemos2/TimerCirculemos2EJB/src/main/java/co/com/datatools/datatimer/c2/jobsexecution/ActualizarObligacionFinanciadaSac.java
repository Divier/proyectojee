...
public class ActualizarObligacionFinanciadaSac extends JobQuartz {

    private static final ILog logger = LoggerC2.getLogger(EnumLogSistema.ACTUALIZAR_OBLIGACION_FINANCIADA_SAC);
    private final static Logger logger2 = Logger.getLogger(ActualizarObligacionFinanciadaSac.class.getName());
    ...
    public ActualizarObligacionFinanciadaSac() {
        super();
    }

    @Override
    public void execute(JobExecutionContext context) throws JobExecutionException {
        logger2.debug("ActualizarObligacionFinanciadaSac.execute()");
        ...
        try {
            ...
            RespuestaProcesoSacDTO respuesta = iFachadaSac
                    .actualizarObligacionesFinanciadas(organismoTransitoDTO.getCodigoOrganismo());
